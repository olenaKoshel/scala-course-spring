...
* The subtraction operation is an optional challenge.
* Provide test cases and implement them, covering all operations.
* You may use an LLM to generate test cases for numerals, but you are still responsible for them,
  even if they are LLM-generated.
* All tests must pass.
